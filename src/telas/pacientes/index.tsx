...
function Paciente() {
    ...
    const pacientes = [pacienteExemplo, pacienteExemplo, pacienteExemplo, pacienteExemplo, pacienteExemplo]
                    ...
                    </div>
                    {
                        pacientes.map((paciente, index) => (
                            <div onClick={() => navigate("/dadosPaciente")}>
                                <ItemListaPaciente abrirAba={() => {

                                }
                                } key={paciente.id + '-' + index} paciente={paciente} />
                            </div>
                        ))
                    }
                </div>
